...
public class DefaultVectorComparators {
  ...
  public static <T extends ValueVector> VectorValueComparator<T> createDefaultComparator(T vector) {
    if (vector instanceof BaseFixedWidthVector) {
      ...
      return (VectorValueComparator<T>) new LargeVariableWidthComparator();  
   ...
   * The comparison is in lexicographic order, with null comes first.
   */
  public static class LargeVariableWidthComparator extends VectorValueComparator<BaseLargeVariableWidthVector> {
    ...
    @Override
    public VectorValueComparator<BaseLargeVariableWidthVector> createNew() {
      return new LargeVariableWidthComparator();
    }
  }
